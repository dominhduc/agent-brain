...
### [2026-04-19 21:29:15] Version strings use mutable variables to enable build-time overrides via goreleaser ldflags.


### [2026-04-19 21:29:15] Configuration resolution uses a dual-source system that prioritizes project-local settings over global defaults.


### [2026-04-19 21:29:15] Custom LLM providers must be explicitly named in configuration files instead of using a generic placeholder.


### [2026-04-19 21:29:15] Knowledge entries are moved to timestamped archive directories rather than permanently deleted.


### [2026-04-19 21:29:15] Fuzzy deduplication operates with a strict 0.55 similarity threshold to catch near-duplicates without false positives.


### [2026-04-19 21:29:15] Adopting OpenTelemetry with OTLP gRPC and HTTP exporters as the primary distributed tracing standard.


### [2026-04-19 21:29:15] Selecting Chromem-go as an embedded vector database for managing AI agent embeddings and context.


### [2026-04-19 21:29:15] Elevating YAML parsing and terminal I/O libraries to direct dependencies for stable API contracts.
