...
### [2026-04-19 21:29:15] Go defaults to exit code 0, requiring explicit error handling to prevent silent failures.


### [2026-04-19 21:29:15] High trigram-Jaccard similarity thresholds may fail to catch semantically similar duplicate entries.


### [2026-04-19 21:29:15] Unchecked EOF on stdin in TUI mode triggers fatal silent closures instead of graceful exits.


### [2026-04-19 21:29:15] Promoting indirect dependencies to direct requires verifying actual code usage to avoid unnecessary module bloat.


### [2026-04-19 21:29:15] The specified Go 1.25.0 toolchain version exceeds current stable releases and may cause environment compatibility issues.
